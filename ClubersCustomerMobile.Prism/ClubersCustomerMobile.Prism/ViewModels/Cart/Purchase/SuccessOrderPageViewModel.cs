...
{
    public class SuccessOrderPageViewModel : ViewModelBase
    {
        ...
        public SuccessOrderPageViewModel(INavigationService navigationService,
        ...
        private async void ContinueAsync()
        {
            ...
            await _navigationService.NavigateAsync("/NavigationPage/" + nameof(DeliveryTrackingPage),parameters);

            //await _navigationService.NavigateAsync(nameof(DeliveryTrackingPage),parameters);
        }
