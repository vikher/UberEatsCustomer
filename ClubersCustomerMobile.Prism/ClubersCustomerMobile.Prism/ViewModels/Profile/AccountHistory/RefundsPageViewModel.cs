...
{
    public class RefundsPageViewModel : ViewModelBase
    {
        ...
        public RefundsPageViewModel(INavigationService navigationService, IApiService apiService, IPageDialogService dialogService) : base(navigationService)
        {
            Title = "Reembolsos";
